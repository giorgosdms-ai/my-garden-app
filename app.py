...
if password == PASSWORD_SECRET:
    if "my_gardens" not in st.session_state:
        st.session_state.my_gardens = [
            ...
            {"name": "Τεγεας", "day": "Δευτέρα", "weeks": FORTNIGHT_AC},
            {"name": "Πετραν", "day": "Δευτέρα", "weeks": ["Εβδομάδα Α"]},
            {"name": "Αγίας Λαύρας", "day": "Δευτέρα", "weeks": ["Εβδομάδα Α"]},
            {"name": "28ης", "day": "Δευτέρα", "weeks": ["Εβδομάδα Α"]},
            ...
            {"name": "βερα λω φαληρο", "day": "Τρίτη", "weeks": FORTNIGHT_AC},
            {"name": "Πετρούλα", "day": "Τρίτη", "weeks": ["Εβδομάδα Α"]},
            
            # --- ΤΕΤΑΡΤΗ ---
            {"name": "Σταθης", "day": "Τετάρτη", "weeks": ALL_WEEKS},
            {"name": "Μενιδι", "day": "Τετάρτη", "weeks": ALL_WEEKS},
            {"name": "Δίπλα από Στάθη", "day": "Τετάρτη", "weeks": ["Εβδομάδα Α"]},
            {"name": "Ανθουσων", "day": "Τετάρτη", "weeks": FORTNIGHT_AC},
            {"name": "Μακης", "day": "Τετάρτη", "weeks": FORTNIGHT_AC},
            {"name": "Αλέξανδρος", "day": "Τετάρτη", "weeks": FORTNIGHT_AC},
            {"name": "Μεταμόρφωση", "day": "Τετάρτη", "weeks": FORTNIGHT_BD},
            {"name": "Άνω Λιόσια", "day": "Τετάρτη", "weeks": FORTNIGHT_BD},
            
            # --- ΠΕΜΠΤΗ ---
            {"name": "Μετόχιο", "day": "Πέμπτη", "weeks": FORTNIGHT_BD},
            {"name": "Μαρουσι", "day": "Πέμπτη", "weeks": FORTNIGHT_BD},
            {"name": "Μικράς Ασιας 1", "day": "Πέμπτη", "weeks": FORTNIGHT_BD},
            {"name": "Μικρας Ασιας 2", "day": "Πέμπτη", "weeks": FORTNIGHT_BD},
            ...
            # --- ΠΑΡΑΣΚΕΥΗ ---
            {"name": "Μάριος", "day": "Παρασκευή", "weeks": ["Εβδομάδα Α"]},
        ]
    ...
    # (Υπόλοιπος κώδικας για edit/add παραμένει ο ίδιος)
